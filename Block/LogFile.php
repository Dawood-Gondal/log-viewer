    ...
    public function getLogFiles()
    {
        ...
        foreach ($dir as $fileInfo) {
            if (!$fileInfo->isDot()) {
                ...
                $files[] = ['name' => $fileInfo->getFilename(), 'size' => $fileInfo->getSize(), 'size_readable' => $this->filesizeToReadableString($fileInfo->getSize()), 'mod_time' => $fileInfo->getMTime(), 'mod_time_full' => date("F d Y H:i:s.", $fileInfo->getMTime()),];
            }
        }
        ...
        return ['items' => array_slice($files, $start, $limit), 'page' => $page, 'total' => $total, 'totalPages' => $totalPages, 'search' => $search, 'sort' => $sort, 'dir' => $direction,];
    }
